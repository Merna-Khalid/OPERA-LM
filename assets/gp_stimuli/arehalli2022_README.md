...
Note that this repository corrects two errors in the analysis presented in the CoNLL paper which mistakenly excluded some filler words and represented some in-vocabulary words are out-of-vocabulary tokens. These errors are corrected in the arXiv version of the paper.


## Instructions to replicate

### Prepare additional files
Download [pretrained models](https://drive.google.com/file/d/1ForJhFCP2FQ-qu_qvrTd8alqAISHteR9/view?usp=drive_link) to a folder named "models"
...
The surprisal-to-RT conversion models used in both the CoNLL and corrected analyses can be downloaded [here](https://drive.google.com/file/d/11c9WfuweaOxm15jSmACCUwoYPrXVHrVv/view?usp=sharing) and should be placed in `analysis/models/`
